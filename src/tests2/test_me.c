...
int main(void) {
  ...
  Suite *s21_string_test[] = {
      ...
      test_strrchr(), test_strspn(), test_sprintf_c(), test_sprintf_e(),
      test_sprintf_f(), test_strstr(), test_strtok(), test_sprintf_octal(),
      test_sprintf_percent(), test_sprintf_n(), test_sprintf_string(),
      test_sprintf_g(), test_sprintf_unsigned(), test_sprintf_HEX(),
